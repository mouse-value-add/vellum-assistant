 ...
 *
 * Every fixture's `call.input` key set is a shape the tools genuinely send, so a
 * story cannot quietly review a payload the product never produces. Tools carry
 * an `activity` sibling alongside `command` / `path`, and the panel derives its
 * header from the call, so the same sentence appears both as the header and
 * inside the raw input block.
 *
...
/**
 * A fixture's call. Its `id` and `name` are required rather than defaulted: a
 * placeholder tool name would let a fixture that forgot to name its tool render
 * as some other tool's story without failing anything. `input` defaults to
 * empty, so a fixture states only the fields it is actually exercising.
 */
type FixtureCall = Pick<ChatMessageToolCall, "id" | "name"> &
  Partial<ChatMessageToolCall>;

/** The call with its defaults applied. */
function fixtureCall(call: FixtureCall): ChatMessageToolCall {
  return { input: {}, ...call };
}

/** Build a tool-call payload; the status defaults to completed. */
function payload(
  fields: Omit<ToolCallDetailPayload, "kind" | "call" | "status"> & {
    call: FixtureCall;
    status?: ToolCallDetailPayload["status"];
  },
): ToolCallDetailPayload {
  return {
    kind: "tool",
    status: "completed",
    ...fields,
    call: fixtureCall(fields.call),
  };
}

/** Build a search payload; the status defaults to completed. */
function searchPayload(
  fields: Omit<WebSearchDetailPayload, "kind" | "call" | "status"> & {
    call: FixtureCall;
    status?: WebSearchDetailPayload["status"];
  },
): WebSearchDetailPayload {
  return {
    kind: "web_search",
...
export const bashDetail: ToolCallDetailPayload = payload({
  call: {
    id: "tc-bash-1",
    name: "bash",
    input: {
 ...
 */
export const bashStreamingDetail: ToolCallDetailPayload = payload({
  call: {
    id: "tc-bash-2",
    name: "bash",
    input: {
...
export const bashDeniedDetail: ToolCallDetailPayload = payload({
  call: {
    id: "tc-bash-3",
    name: "bash",
    input: {
...
export const bashErrorDetail: ToolCallDetailPayload = payload({
  call: {
    id: "tc-bash-4",
    name: "bash",
    input: {
...
export const fileReadDetail: ToolCallDetailPayload = payload({
  call: {
    id: "tc-file-read-1",
    name: "file_read",
    input: {
...
export const fileReadMissingDetail: ToolCallDetailPayload = payload({
  call: {
    id: "tc-file-read-2",
    name: "file_read",
    input: {
 ...
 */
export const fileReadEmptyDetail: ToolCallDetailPayload = payload({
  call: {
    id: "tc-file-read-3",
    name: "file_read",
    input: {
...
export const fileWriteDetail: ToolCallDetailPayload = payload({
  call: {
    id: "tc-file-write-1",
    name: "file_write",
    input: {
 ...
 */
export const fileEditDetail: ToolCallDetailPayload = payload({
  call: {
    id: "tc-file-edit-1",
    name: "file_edit",
    input: {
...
export const rememberDetail: ToolCallDetailPayload = payload({
  call: {
    id: "tc-remember-1",
    name: "remember",
    input: {
...
export const recallDetail: ToolCallDetailPayload = payload({
  call: {
    id: "tc-recall-1",
    name: "recall",
    input: {
...
export const codeSearchDetail: ToolCallDetailPayload = payload({
  call: {
    id: "tc-code-search-1",
    name: "code_search",
    input: {
 ...
 */
export const subagentSpawnDetail: ToolCallDetailPayload = payload({
  call: {
    id: "tc-subagent-1",
    name: "subagent_spawn",
    input: {
 ...
 */
export const managedWorkspaceDetail: ToolCallDetailPayload = payload({
  call: {
    id: "tc-managed-1",
 ...
 */
export const mcpDetail: ToolCallDetailPayload = payload({
  call: {
    id: "tc-mcp-1",
    name: "mcp__analytics__exec",
    input: {
...
export const mcpSqlDetail: ToolCallDetailPayload = payload({
  call: {
    id: "tc-mcp-2",
    name: "mcp__warehouse__execute_sql",
    input: {
 ...
 */
export const unknownToolDetail: ToolCallDetailPayload = payload({
  call: {
    id: "tc-unknown-1",
    name: "acme_crm_upsert_contact",
    input: {
      record: {
 ...
 */
export const largeOutputDetail: ToolCallDetailPayload = payload({
  call: {
    id: "tc-bash-large",
    name: "bash",
    input: {
 ...
 */
export const minimalDetail: ToolCallDetailPayload = payload({
  call: {
    id: "tc-file-list-1",
    name: "file_list",
    input: {
...
export const skillLoadDetail: ToolCallDetailPayload = payload({
  call: {
    id: "tc-skill-load-1",
    name: "skill_load",
    input: { activity: "Loading the app-builder skill", skill: "app-builder" },
 ...
 */
export const skillLoadLongDetail: ToolCallDetailPayload = {
  ...skillLoadDetail,
  call: {
    ...skillLoadDetail.call,
    id: "tc-skill-load-long",
...
export const skillLoadRunningDetail: ToolCallDetailPayload = {
  ...skillLoadDetail,
  call: {
    ...skillLoadDetail.call,
    id: "tc-skill-load-running",
    result: undefined,
  },
  status: "running",
};
...
export const skillLoadErrorDetail: ToolCallDetailPayload = payload({
  call: {
    id: "tc-skill-load-2",
    name: "skill_load",
    input: { activity: "Loading the meet-join skill", skill: "meet-join" },
    result:
 ...
 */
export const skillExecuteDetail: ToolCallDetailPayload = payload({
  call: {
    id: "tc-skill-exec-1",
    name: "skill_execute",
    input: {
...
export const thinkingDetail: ThinkingDetailPayload = {
  kind: "thinking",
  title: "Thinking",
  thinkingText: [
 ...
 */
export const webFetchDetail: ToolCallDetailPayload = payload({
  call: {
    id: "tc-web-fetch-1",
    name: "web_fetch",
    input: {
 ...
 */
export const webSearchErrorDetail: WebSearchDetailPayload = searchPayload({
  call: {
    id: "tc-web-search-2",
    name: "web_search",
 ...
 */
export const webSearchDetail: WebSearchDetailPayload = searchPayload({
  call: {
    id: "tc-web-search-1",
    name: "web_search",
    input: { activity: "Searching the web", query: "storybook autodocs tag" },
