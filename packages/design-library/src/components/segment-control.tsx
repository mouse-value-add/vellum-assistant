...
export function SegmentControl<T extends string>({
  ...
  // Segments stand 28px tall (h-7), 32px overall once the group's own 2px
  // padding is counted. Sublabels add a second line that fixed sizing would
  // clip, so they let height follow content instead. iconOnly never renders
  // sublabels (see the render below).
